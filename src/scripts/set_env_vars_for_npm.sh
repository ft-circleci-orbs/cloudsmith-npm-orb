...
NPM_CONFIG_URL="https://npm.$CLOUDSMITH_DOWNLOADS_DOMAIN/$CLOUDSMITH_REPOSITORY/"
NPM_CONFIG_AUTH="//npm.$CLOUDSMITH_DOWNLOADS_DOMAIN/$CLOUDSMITH_REPOSITORY/:_authToken=$CLOUDSMITH_OIDC_TOKEN"

echo "export NPM_CONFIG_URL=\"$NPM_CONFIG_URL\"" >> "$BASH_ENV"
echo "export NPM_CONFIG_AUTH=\"$NPM_CONFIG_AUTH\"" >> "$BASH_ENV"
...
echo "The following npmrc environment variables have also been exported:"
echo ""
echo "NPM_CONFIG_URL=https://npm.$CLOUDSMITH_DOWNLOADS_DOMAIN/$CLOUDSMITH_REPOSITORY/"
echo "NPM_CONFIG_AUTH=//npm.$CLOUDSMITH_DOWNLOADS_DOMAIN/$CLOUDSMITH_REPOSITORY/:_authToken=**************"
